...
class BuildHandler(FileSystemEventHandler):
    ...
    def on_modified(self, event):
        ...
        if any(rel_path.startswith(exclude) for exclude in self.exclude_list):
            return
...
if __name__ == '__main__':
    ...
    exclude_list = ['dist', 'manifest.json', 'manifest_chrome.json', 'manifest_firefox.json', 
                   'manifest_ffdroid.json', 'build.py', '.git', '.gitignore', 'requirements.txt']
